...
$lang['addpage_createns']      = 'Разрешить создание подпространств имен. Если этот флажок снят, двоеточия (<code>:</code>) в названии страницы будут заменены на подчеркивание (<code>_</code>).';
