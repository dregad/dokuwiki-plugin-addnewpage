...
$lang['addpage_autopage']      = 'Не показывайте поле ввода, предварительно настроенное пространство имен обрабатывается как полный идентификатор страницы. (имеет смысл использовать заполнители даты)';
